...
class traffic_sign_recogninzer_filter(object):
    sift = None
    sign_label = [
        'stop',
        'school_zone',
    ...
    sign_input_paths = [
        ...
        '/Users/hbojja/uiuc/CS445-CP/FinalProject/input/traffic_signs/school_zone_3.jpeg',
        ...
        '/Users/hbojja/uiuc/CS445-CP/FinalProject/input/traffic_signs/cross_walk.jpeg'
    ]
